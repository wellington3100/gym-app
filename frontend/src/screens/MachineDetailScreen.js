// src/screens/MachineDetailScreen.js
...
import { BarbellIcon, PulleyIcon } from '../assets/icons';
    ...
    <ScrollView style={styles.container}>
      <View style={styles.machineHeader}>
        ...
        <View style={styles.iconContainer}>
          {currentMachine.type === 'Barra' 
            ? <BarbellIcon width={50} height={50} color="white" /> 
            : <PulleyIcon width={50} height={50} color="white" />
          }
        </View>
      </View>
